...
if (isset($_POST['update'])) {
    ...
    // print_r($data);
    $sql = "UPDATE status_privacy SET privacy_policy=:privacy_policy WHERE id=:id";
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div id="privacy-policy-three" class="privacy-policy">
                                    <form method="post">
                                        <textarea class="form-control" id="ckeditor" name="privacy_policy"><?php echo $row['privacy_policy']; ?></textarea>
