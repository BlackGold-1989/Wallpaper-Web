...
<body>
        ...
        <div class="content-body">
            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    ...
                    <a href="wallpapers.php" class="btn btn-primary">All Wallpaper</a>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Rejected Wallpapers</h4>
                                <div class="table-responsive" id="table-display">
                                    <?php include('inc/rejected_photo_table.php'); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <form method="post" name="editphoto" class="editphoto" id="editphoto">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="text" class="form-control" id="wallpaper_color" name="wallpaper_color">
                        </div>
    ...
    ***********************************-->
    ...
    $("#update").click(function(){
        ...
        var wallpaper_color= $("#wallpaper_color").val();
    ...
    function PhotoTable() {
        $.ajax({
            url:'inc/rejected_photo_table.php',
            method:'POST',
            success:function(data){
    ...
    function GetData(id) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#wallpaper_color').val(response.wallpaper_color);
            },
